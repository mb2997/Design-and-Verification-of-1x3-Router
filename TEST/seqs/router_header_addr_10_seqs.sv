`ifndef ROUTER_HEADER_ADDR_10_SEQS
`define ROUTER_HEADER_ADDR_10_SEQS

class router_header_addr_10_seqs extends router_wr_seqs;

    //Factory registration
    `uvm_object_utils(router_header_addr_10_seqs)

    //New constructor
    function new(string name = "router_header_addr_10_seqs");
        super.new(name);
    endfunction
...
endclass : router_header_addr_10_seqs
