...
package router_pkg;
    ...
    `include "/seqs/router_header_addr_11_seqs.sv"
    `include "/seqs/router_header_len_0_seqs.sv"
    ...
    `include "/tests/router_header_addr_11_test.sv"
    `include "/tests/router_header_len_0_test.sv"
